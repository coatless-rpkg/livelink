...
#> Parsing file data...
#> Created directory: '/tmp/RtmpeibMax/recovered/webr_f40f99ea'
#> Decoding 1 file...
#> 'plot.R' (16 bytes)
#> ✔ Successfully decoded 1 file to '/tmp/RtmpeibMax/recovered/webr_f40f99ea'
result
#> 
#> ── webR Decoded Files ──
#> 
#> Source:
#> <https://webr.r-wasm.org/latest/#code=eJyb2LwkLzE3dVlBTn6JXtCSgsSSjK36Gfm5qfrlqUnxpcWpRfpQqZLUipINGZnFJRpFeflFuRqGBgaamgBhqxlI&mz>
#> Output: '/tmp/RtmpeibMax/recovered/webr_f40f99ea'
#> 
#> Files (1):
#> 'plot.R' (16 bytes)
#> 
...
#> ✔ Successfully decoded 0 files to '/tmp/RtmpeibMax/recovered/webr_f40f99ea'
#> 
#> 
#> ── webR Decoded Files ──
#> 
...
#> Decompressing webR data...
#> Parsing file data...
#> Created directory: '/tmp/RtmpeibMax/roundtrip/webr_45b92ad7'
#> Decoding 3 files...
#> 'main.R' (23 bytes)
#> 'utils.R' (20 bytes)
#> 'README.md' (33 bytes)
#> ✔ Successfully decoded 3 files to '/tmp/RtmpeibMax/roundtrip/webr_45b92ad7'
...
#> Parsing file data...
#> Created directory: '/tmp/RtmpeibMax/app/shinylive_6f92fb6e'
#> Decoding 1 file...
#> 'app.R' (text, 55 bytes)
#> ✔ Successfully decoded 1 file to '/tmp/RtmpeibMax/app/shinylive_6f92fb6e'
#> 
#> 
...
#> <https://shinylive.io/r/editor/#code=NobwRAdghgtgpmAXGKAHVA6ASmANGAYwHsIAXOMpMAGwEsAjAJykYE8AKAZwAtaJWAlAB0IPPqwCC6dgDNqAV1oATAApQA5nHYDcAAhnyIBUrRLtaeogN0gAvgLxhSrVAmTkAHqTC2AukA>
#> 
#> Output: '/tmp/RtmpeibMax/app/shinylive_6f92fb6e'
#> 
#> 
#> 
#> Files (1):
...
#> Decompressing webR data...
#> Parsing file data...
#> Created directory: '/tmp/RtmpeibMax/batch/script_01'
#> Decoding 1 file...
#> 'one.R' (10 bytes)
#> ✔ Successfully decoded 1 file to '/tmp/RtmpeibMax/batch/script_01'
#> 
#> 
#> 
...
#> Decompressing webR data...
#> Parsing file data...
#> Created directory: '/tmp/RtmpeibMax/batch/script_02'
#> Decoding 1 file...
#> 'two.R' (15 bytes)
#> ✔ Successfully decoded 1 file to '/tmp/RtmpeibMax/batch/script_02'
#> 
...
#> ── webR Decoded Batch ──
#> 
#> Base directory: '/tmp/RtmpeibMax/batch'
#> Total URLs: 2
#> 
#> Successfully processed 2 URLs:
#> 'script_01': 1 file
#> '/tmp/RtmpeibMax/batch/script_01'
#> 
#> 'script_02': 1 file
#> '/tmp/RtmpeibMax/batch/script_02'
#> 

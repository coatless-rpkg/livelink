...
![Encoding and decoding are inverse operations. The files you put into a link are the files you get back, byte for byte, with no server and no network.](figures/roundtrip-light.svg){.ll-fig .ll-light}
![](figures/roundtrip-dark.svg){.ll-fig .ll-dark aria-hidden="true"}

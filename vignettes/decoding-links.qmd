...
![Encoding a link and decoding it again are inverse operations: the files you put in are the files you get back.](../man/figures/livelink-roundtrip.svg){fig-alt="A round-trip diagram. On the left, a set of R files flows through webr_repl_link into a URL. On the right, the same URL flows back through decode_webr_link into the identical set of files."}
...
produced here; you do not have to know or care which tool made it.

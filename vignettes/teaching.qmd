...
![webR has four panels. `panels` names the ones you want; the rest never appear.](figures/panels-light.svg){.ll-fig .ll-light}
![](figures/panels-dark.svg){.ll-fig .ll-dark aria-hidden="true"}
